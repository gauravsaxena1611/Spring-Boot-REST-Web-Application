...
public class SurveyControllerRefactoredIT {
	...
	public void retrieveAllSurveyQuestions() throws Exception {
		...
		ResponseEntity<List<Question>> response = restTemplate.exchange(createURLWithPort("/surveys/Survey1/questions"), HttpMethod.GET, new HttpEntity<String>("DUMMY_DOESNT_MATTER", headers),
